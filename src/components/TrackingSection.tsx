...
type TrackingSectionType = 'circular'

type TrackingSectionProps = {
  title: string
  options: TrackingOption[]
  type?: TrackingSectionType
  hasInfoIcon?: boolean
  onChange?: (key: string, selected: boolean) => void
  isTwoRow?: boolean
}

export default function TrackingSection({ title, options, type = 'circular', hasInfoIcon = false, onChange, isTwoRow = false }: TrackingSectionProps): ReactElement {
  ...
  const handleOptionChange = (optionKey: string) => {
    ...
    const newState: Record<string, boolean> = { ...selectedOptions }
