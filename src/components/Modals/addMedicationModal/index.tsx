...
import MUITextField from '../../common/common-textfield'
import MUISelect from '../../common/common-mui-select'
...
export default function AddMedicationModal({ open, onClose, onSave }: AddMedicationModalProps) {
