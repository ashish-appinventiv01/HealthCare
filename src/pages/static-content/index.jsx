...
import { getStaticRenderConfig, LEGAL_COPY } from './static-content.helper.jsx'

// Lazy-load to keep bundles small when a specific page isn't needed
const FAQs = lazy(() => import('./faq/FAQs.jsx'))
const LegalContent = lazy(() => import('./commonLegalContent/LegalContent.jsx'))


export default function StaticContent({ initialPage }) {
