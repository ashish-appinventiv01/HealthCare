...
import useInsightsHelper from './insights.helper'
            ...
            {cycleData.map((cycle) => (
              <div key={cycle.id} className="cycle-card">
                ...
                >
                  ...
                  <img className={expandedCards[cycle.id] ? 'chevron rotated' : 'chevron'} src={Chevron} width="20" height="20" alt="Chevron" />
                </div>
          ...
          <div className="chart-content">
            ...
            <div className="cycle-selector">
              ...
              <div className="cycle-dropdown">
                <img className={'chevron'} src={Chevron} width="20" height="20" alt="Chevron" />
              </div>
            </div>
